...
import com.apostassa.aplicacao.usecase.jogo.role.*;
...
import com.apostassa.infra.gateway.jogo.role.RoleJogoWebPresenter;
...
public class RoleJogoAdminServlet extends HttpServlet {
    ...
    private RoleJogoWebPresenter adapter;
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.adapter = new RoleJogoWebPresenter();
